...
- Full balance reconciliation from private `Остатки` rows still needs browser state or a safe credential path.
...
- Live endpoint responses should be checked before claims on concrete bugs.
