...
- project name: Cloudflare Pages project ezohata-dashboard
...
- May be separate from current finance/Vercel incoming
  ledger production.
...
- Verify whether this is legacy dashboard, active dashboard,
  or archived target.

## 11. Risks

- Confusing Cloudflare dashboard with Vercel incoming
  ledger.
