...
[INPUT]
Dashboard data, daily thinking/audit data, morning report data, and mobile-run requests.

↓

[PROCESSING]
scripts/refresh-management-dashboards.js refreshes management dashboard data and report artifacts.

↓

[STORAGE]
dashboard-thinking/data/ contains current dashboard JSON snapshots.
