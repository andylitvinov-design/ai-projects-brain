...
4. `behavior replay fixture passed` — deterministic saved-output fixtures passed locally/CI, but live model behavior is still not proven;
5. `behavior replay passed` — a replay runner, live automation evidence, or real prevention evidence supports promoting behavior rules.
