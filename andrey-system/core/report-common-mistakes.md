...
The agent thinks a report is good because it contains:
...
Do not imitate Full Client Report when there is no client story, symptom detail, remedy reaction, or follow-up context.
...
```md
Дерево отвечает за рост, движение, инициативу, право действовать...
Огонь отвечает за радость, контакт, живость...
```

This teaches the method instead of showing what is happening now.
...
If there is no client history, body details, remedy reaction, support history, or follow-up context, label it:
