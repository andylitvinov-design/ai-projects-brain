# Compact Repeat Wu Xing + Bach Note

Status: canonical supplement for Report Agent and Report Style Auditor.

Use this rule when the user gives:

- previous Wu Xing / resource values;
- current Wu Xing / resource values;
- 3–6 Bach remedies or similar supports;
- a request to recheck current dynamics after previous support.
...
```md
может совпадать с фазой сброса напряжения;
это не медицинский вывод;
лучше просто наблюдать динамику.
```
