...
Each project memory record should include these fields when known:
...
- If multiple targets exist, distinguish production, preview, and local.
...
- Example shape: `Vercel project foo`, `Cloudflare Pages bar`,
...
- Current state in operational terms: active, archived, broken, partial,
  migration in progress, or `needs verification`.
...
- If the set is incomplete, include known names and mark the rest
  `needs verification`.
...
- Recent important work with enough context to understand momentum.
- Use short factual bullets, not long narratives.

### next actions

- Concrete follow-up actions an agent or human can take next.

### risks

- What could break, what could be confused, or what must be preserved.
